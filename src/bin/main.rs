...
static EXERCISE_REGISTRY: LazyLock<HashMap<&'static str, Box<dyn Exercise>>> =
    LazyLock::new(|| {
        ...
        m.insert("7.4", Box::new(exercises::ch07::X4));
        m
    });
...
static EXAMPLE_REGISTRY: LazyLock<HashMap<&'static str, Box<dyn Example>>> = LazyLock::new(|| {
    ...
    m.insert("07.19", Box::new(examples::ch07::EG19));
    m.insert("07.20", Box::new(examples::ch07::EG20));
    m.insert("07.21", Box::new(examples::ch07::EG21));
    m.insert("07.22", Box::new(examples::ch07::EG22));
    m.insert("07.23", Box::new(examples::ch07::EG23));
    // apdx_e
    ...
    m.insert("E.07", Box::new(examples::apdx_e::EG07));
    m
});
